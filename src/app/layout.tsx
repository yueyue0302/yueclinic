...
export const metadata: Metadata = {
  ...
  description: '千葉県市川市・鬼越駅徒歩20秒。目元専門の美容外科「yueclinic」公式サイト。二重埋没法¥68,000〜、クマ取り¥80,000〜。院長がカウンセリングから手術、術後フォローまで一貫対応。市川・本八幡・船橋エリアで二重整形・眼瞼下垂・クマ取り・眉下切開を相談できます。',
  ...
  openGraph: {
    ...
    description: '千葉県市川市・鬼越駅徒歩20秒。目元専門の美容外科。院長一貫対応、ワンプライス制、二重埋没法¥68,000〜。',
            ...
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "千葉県市川市北方1-9-14の2階、京成本線「鬼越駅」から徒歩20秒の場所にあります。京成八幡（本八幡）から1駅、京成船橋から3駅です。"
                  }
                },
                {
                  "@type": "Question",
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "京成船橋駅から京成本線で約8分（3駅）、京成八幡駅（本八幡）から約2分（1駅）です。鬼越駅を降りたら徒歩20秒で当院に到着します。"
                  }
                }
              ]
            })
