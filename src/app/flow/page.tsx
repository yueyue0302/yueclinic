...
const faqItems = [
  {
    ...
    answer:
      '予約状況と診察結果により可能です。未成年の方も、初回から親権者様にご同伴いただき、必要事項を確認できる場合は当日施術をご案内できます。当日施術を希望される場合は、LINE予約時にその旨をお知らせください。',
  },
  {
      ...
      <main className="section fade-in" style={{ maxWidth: '900px', margin: '1.5rem auto 4rem' }}>
        ...
        >
          ...
          <p style={{ color: '#555', lineHeight: 1.85 }}>
            ...
            未成年の方は、初回から親権者様にご同伴いただき、同意書や必要事項を確認できる場合は当日施術も可能です。
            既往歴や内服薬がある方、他院修正のご相談などでは、事前確認や別日手術をご提案する場合があります。
          </p>
        </section>
